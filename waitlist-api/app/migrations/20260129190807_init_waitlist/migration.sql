...
-- CreateIndex
CREATE UNIQUE INDEX "IntegrationKey_key_key" ON "IntegrationKey"("key");
...
-- AddForeignKey
ALTER TABLE "IntegrationKey" ADD CONSTRAINT "IntegrationKey_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
